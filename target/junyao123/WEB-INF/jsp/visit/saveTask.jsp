    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#saveBtn").click(function () {
                if ($.trim($("#create-owner").val()) === "" || $.trim($("#create-theme").val()) === "" || $.trim($("#contactsName_01").val()) === "") {
                    alert("请把必要信息填写完整!");
                    return false;
                }
                $("#taskForm").submit();
...
<form action="workbench/visit/save.do" id="taskForm" class="form-horizontal" role="form">
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-theme" name="theme">
        </div>
    </div>
    <div class="form-group">
        <label for="create-expectedDate" class="col-sm-2 control-label">到期日期</label>
        <div class="col-sm-10" style="width: 300px;">
    ...
    <div style="position: relative; left: 103px;">
        <span><b>提醒时间</b></span>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="checkbox" id="reminderTime" name="">
    </div>
    ...
    <div id="reminderTimeDiv"
        ...
        <div class="form-group" style="position: relative; top: 10px;">
            ...
            <div class="col-sm-10" style="width: 300px;">
                <input type="text" class="form-control time1" id="create-startDate" name="startDate">
            </div>
        </div>
        ...
        <div class="form-group" style="position: relative; top: 20px;">
            <label for="create-notifyType" class="col-sm-2 control-label">通知类型</label>
            <div class="col-sm-10" style="width: 300px;">
                <select class="form-control" id="create-notifyType" name="notifyType">
                    <option></option>
                    <option>邮箱</option>
                    <option>弹窗</option>
                </select>
