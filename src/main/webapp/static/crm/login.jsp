        ...
        function login() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.success) {
                        window.location.href = "static/crm/workbench/index.jsp";
                    } else {
                        $("#msg").html(data.msg);
                    }
                }
...
<section class="login">
    ...
    <div style="position: relative;width:550px;height:400px;margin: 12% auto;">
        <div style="position: relative;margin: 0 10%;">
            ...
            <form action="static/crm/workbench/index.html" class="form-horizontal" role="form" style="position: relative;top: 20px">
